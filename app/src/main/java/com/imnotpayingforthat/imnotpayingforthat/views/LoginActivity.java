...
import com.imnotpayingforthat.imnotpayingforthat.MainActivity;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.login_button_loginButton).setOnClickListener(this);
    ...
    // TODO: 11/04/2018 Kommunikering af fejl - evt. kig på sexy snackbar
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.main_googleLoginButton:
                ...
                break;
            case R.id.main_facebookLoginButton:
                loginManager.logInWithReadPermissions(this, Arrays.asList(EMAIL, PROFILE));
                showProgressBar();
                break;
    ...
    private void handleFacebookAccessToken(@NonNull AccessToken token) {
        ...
        // TODO: 11/04/2018 Ikke fan af at new user her, og så ændre felterne senere. Felterne burde i best-case være immutable
        user = new User();

        // TODO: 11/04/2018 getFacebookData sætter et request i gang async, så man fortsætter med ret stor sikkerhed med "signInWithCredential" inden det request er færdigt.
        // TODO: 11/04/2018 signInWithCredential burde nok kaldes i forbindelse med et success scenarie når den request er gennemført.
        getFacebookData(token);
        signInWithCredential(credential);
    }

    private void getFacebookData(AccessToken token) {
        GraphRequest request = GraphRequest.newMeRequest(
                token,
                (object, response) -> {
                    try {
                        // TODO: 11/04/2018 Er det en mini-micro optimization at hente jsonObjektet og så kalde på det,
                        // I stedet for at kalde response.getJSONObject() flere gange?
                        ...
                        {
                            // TODO: 10/04/2018 externalize magic numbers
                            user.setProfile_Image(profile.getProfilePictureUri(200,200).toString());
                        }
                    } catch (JSONException e) {
                        Log.d(TAG, "Failed to get facebook information:" + e.getMessage());
                    }
                }
        );
